...
def process_image(file_path: str):
    """
    여기에 main.py의 이미지 처리 함수를 import해서 사용하세요.
    예: from main import your_processing_function
        result = your_processing_function(file_path)
    """
    # 현재는 placeholder - 실제 처리 함수로 교체하세요
    print(f"Processing image: {file_path}")
    # return your_processing_function(file_path)
